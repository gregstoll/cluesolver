...
class NodeImpl {
	 ...
	 * @param jso The javascript version of the node
	 */
	 ...
	 * @param expr The xpath expression to get the child node
	...
	public native JavaScriptObject getNode( String expr ) /*-{
	 ...
	 var node = this.@com.gwt.components.client.xslt.NodeImpl::jsNode;
	 ...
	 * @param nodeList The node list to populate with the child nodes
	 */
	public native void getNodes( String expr, List nodeList ) /*-{
	 if ( nodeList == null ) {
	 return;
	 }
	 ...
	 var n = nodeSet[ i ];
	 nodeList.@java.util.List::add(Ljava/lang/Object;)( @com.gwt.components.client.xslt.Node::create(Lcom/google/gwt/core/client/JavaScriptObject;)( n ) );
	 }
	 }-*/;
	 ...
	 * @param nodeList The list to populate
	 */
	public native void getChildNodes( List nodeList ) /*-{
