...
public class XML {
	 ...
	 * @param xmlString An xml node as a string
	 * @return The DOM representation for the XML node
	 * @throws XMLParseException Thrown if a parsing error occurs
	 */
	...
	private static native Node parseImpl( String xmlString ) /*-{
	 ...
	 var domDoc = @com.gwt.components.client.xslt.XML::domParser.parseFromString( xmlString, "text/xml" );
	 ...
	 return @com.gwt.components.client.xslt.Node::create(Lcom/google/gwt/core/client/JavaScriptObject;)( domDoc );
	 }-*/;
